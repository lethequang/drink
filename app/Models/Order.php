...
class Order extends Model
{
    ...
    protected $fillable = ['asset_id', 'number', 'address_from', 'address_to', 'phone_from', 'phone_to','comment', 'total', 'email_from', 'email_to','is_deleted',
        'status', 'name_customer_from', 'name_customer_to', 'gender_from', 'gender_to', 'created_at', 'updated_at'];
...
//    protected $hidden = ['parent_id', 'is_deleted'];
    ...
    public static function getListAll($filter)
    {
        ...
        if (isset($filter['status'])) {
            $sql->where('orders.status', $filter['status']);
        }
