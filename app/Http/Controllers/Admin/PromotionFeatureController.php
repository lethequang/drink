...
class PromotionFeatureController extends Controller
{
    private $_data = array();
    private $_model;
    ...
    {
        $this->_data['title'] = 'Thuộc tính khuyến mãi';
        $this->_data['controllerName'] = 'promotion-feature';
        $this->_model = new PromotionFeature();
    }
    ...
    public function search(Request $request)
    {
        $filter = [
            ...
            'sort' => $request->input('sort', 'promotion_features.id'),
