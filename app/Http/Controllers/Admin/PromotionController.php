...
class PromotionController extends Controller
{
    ...
    {
        $this->_data['title'] = 'Khuyến mãi';
        $this->_data['controllerName'] = 'promotion';
    ...
    public function create()
    {
        ...
        $promotionFeature = array('' => '') + PromotionFeature::getPromotionFeature();
        ...
        $this->_data['promotionFeature'] = $promotionFeature;
