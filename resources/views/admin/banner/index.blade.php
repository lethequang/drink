                ...
                <div class="box">
                    ...
                    <div class="box-body overflow-hidden">
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                {!! Form::select('position_id', $banner_position, null, [
                                    'id' => 'banner_position',
                                    'class' => 'custom_filter',
                                    'data-placeholder' => '--- Vị trí ---']) !!}
                            </div>
                            <div class="col-sm-1">
                        ...
                        >
                            ...
                            <tr>
                                ...
                                <th data-field="name" data-sortable="true">Tên banner</th>
                                <th data-field="image_location" data-formatter="formatImage">Hình banner</th>
                                <th data-field="banner_positions_name" data-sortable="true">Vị trí</th>
                                <th data-field="ordering" data-sortable="true">Thứ tự hiển thị</th>
                                <th data-field="url" data-sortable="true">Link</th>
...
@section('after_scripts')
    ...
    <script type="text/javascript">
        ...
        function queryParams(params) {
            ...
            params.banner_position = $('#banner_position').val();
        ...
        function formatImage(value, row, index) {
            ...
            var url = '<img src="' + row['image_url'] + value +'" width="300" onerror="this.src=\'/images/no-image.jpeg\';">';
        ...
        function activeItems(items, e) {
            ...
            {{--malert('Bạn có thật sự muốn kích hoạt {{$title}} này không?', 'Xác nhận kích hoạt {{$title}}', null, function () {--}}
                var url = '{{ url("/panel-kht/banner/ajax-active") }}';
                var data = {
                    '_token': '{{ csrf_token() }}',
                    'ids': items
                };
...
//            });
        ...
        function inactiveItems(items, e) {
            ...
            {{--malert('Bạn có thật sự muốn ngừng kích hoạt {{$title}} này không?', 'Xác nhận ngừng kích hoạt {{$title}}', null, function () {--}}
                var url = '{{ url("/panel-kht/banner/ajax-inactive") }}';
                var data = {
                    '_token': '{{ csrf_token() }}',
                    'ids': items
                };
...
//            });
        ...
        function deleteItems(items, e) {
            ...
            malert('Bạn có thật sự muốn xoá {{$title}} này không?', 'Xác nhận xoá {{$title}}', null, function () {
                var url = '{{ url("/panel-kht/banner/ajax-delete") }}';
                var data = {
                    '_token': '{{ csrf_token() }}',
                    'ids': items
                };
