                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8" id="demo-dp-range">
                                            <div class="input-daterange input-group" id="datepicker">
                                                <input id="date_from" type="text" class="form-control"
                                                       name="date_from"
                                                       value="<?= isset($object['id']) ? @$object['date_from'] : '' ?>"/>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-sm-8" id="demo-dp-range">
                                            <div class="input-daterange input-group" id="datepicker">
                                                <input id="date_to" type="text" class="form-control"
                                                       name="date_to"
                                                       value="<?= isset($object['id']) ? @$object['date_to'] : '' ?>"/>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            {!! Form::select('promotion_id', $promotionFeature, null, [
                                                    'id' => 'promotion_id',
                                                    'class' => 'form-control select2',
                                    ...
                                    <div class="form-group">
                                        ...
                                        <a id="addPromotionFeatureVariant" href="" class="btn btn-primary"><i
...
@section('after_scripts')
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#addPromotionFeatureVariant').on('click', function (e) {
                e.preventDefault();
                addPromotionFeatureVariant();
            });
        ...
        function addPromtionFeatureVariant() {
            var from = $('#from').val();
            var to = $('#to').val();
            ...
            if (from != "" && to != "") {
                ...
                $.post({
                    url: "/panel-kht/promotion-feature-variant/ajax-create/" + from + "/" + to + "/" + AssetFeaature, data2, success: function (result) {
                        // console.log(result);
