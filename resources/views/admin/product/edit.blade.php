                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <label class="radio-inline">
                                                <input type="radio" name="is_deleted" id="is_deleted1" value="0" <?=$object['is_deleted']=='0'?'checked':''?>> Kích hoạt
                                            </label>
                                            <label class="radio-inline">
                                ...
                                <div class="col-sm-5">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            {!! Form::select("parent_id", $parentOptions, $object['parent_id'], ['id' => 'parent_id','class' => 'form-control select2','data-placeholder' => '--- Chọn nhóm hàng cha ---']) !!}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            {!! Form::select("manufacturer_id", $manufacturerOptions, $object['manufacturer_id'], ['id' => 'manufacturer_id','class' => 'form-control select2','data-placeholder' => '--- Chọn hãng sản xuất ---']) !!}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8 btn-file">
                                            ...
                                            {!! Form::text("image", $object['image'], ['id' => 'image', 'data-url' => '#image_url']) !!}
                                            {!! Form::text("image_url", $object['image_url'], ['id' => 'image_url']) !!}
