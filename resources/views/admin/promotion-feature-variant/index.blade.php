                ...
                <div class="box">
                    ...
                    <div class="box-body overflow-hidden">
                            <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                            {!! Form::select('promotionFeature', $promotionFeature, '', [
                                                'id' => 'promotionFeature',
                                                'class' => 'custom_filter',
                                                'data-placeholder' => '--- Thuộc tính ---']) !!}
                                        </div>
                        ...
                        >
                            ...
                            <tr>
                                ...
                                <th data-field="feature_name" data-sortable="true">Danh mục filter</th>
                                <th data-field="name" data-sortable="true">Tên filter</th>
...
@section('after_scripts')
    ...
    <script type="text/javascript">
        ...
        function queryParams(params) {
            params.promotionFeature = $('#promotionFeature').val();
        ...
        function activeItems(items, e) {
            ...
            {{--malert('Bạn có thật sự muốn kích hoạt {{$title}} này không?', 'Xác nhận kích hoạt {{$title}}', null, function () {--}}
                var url = '{{ url("/panel-kht/asset-feature-variant/ajax-active") }}';
                var data = {
                    '_token': '{{ csrf_token() }}',
                    'ids': items
                };
...
//            });
        ...
        function inactiveItems(items, e) {
            ...
            {{--malert('Bạn có thật sự muốn ngừng kích hoạt {{$title}} này không?', 'Xác nhận ngừng kích hoạt {{$title}}', null, function () {--}}
                var url = '{{ url("/panel-kht/asset-feature-variant/ajax-inactive") }}';
                var data = {
                    '_token': '{{ csrf_token() }}',
                    'ids': items
                };
...
//            });
        ...
        function deleteItems(items, e) {
            ...
            malert('Bạn có thật sự muốn xoá {{$title}} này không?', 'Xác nhận xoá {{$title}}', null, function () {
                var url = '{{ url("/panel-kht/asset-feature-variant/ajax-delete") }}';
                var data = {
                    '_token': '{{ csrf_token() }}',
                    'ids': items
                };
