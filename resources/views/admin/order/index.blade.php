                ...
                <div class="box">
                    ...
                    <div class="box-body overflow-hidden">
                        ...
                        >
                            <thead>
                            <tr>
                                <th data-field="check_id" data-checkbox="true"></th>
                                <th data-field="id" data-sortable="true">Mã đơn hàng</th>
                                <th data-field="name_customer_from" data-sortable="true">Khách hàng</th>
                                <th data-field="total" data-sortable="true">Tổng cộng</th>
                                <th data-field="updated_at" data-sortable="true">Thời gian</th>
...
@section('after_scripts')
    ...
    <script type="text/javascript">
        ...
        function formatStatus(value, row, index) {
            ...
            if(value == 1)
            {
                return '<span class="label label-sm label-success">Đặt hàng thành công</span>'
            }
            if(value == 2)
            {
                return '<span class="label label-sm label-danger">Đã xác nhận</span>'
            }

            if(value == 3)
            {
                return '<span class="label label-sm label-warning">Chuyển giao nhận</span>';
            }
            if(value == 4)
            {
                return '<span class="label label-sm label-success">Chở giao hàng</span>'
            }
            if(value == 5)
            {
                return '<span class="label label-sm label-danger">Đã giao hàng</span>'
            }

            if(value == 6)
            {
                return '<span class="label label-sm label-warning">Đã thanh toán</span>';
            }
            else
            {
                return '<span class="label label-sm label-warning">Hủy đơn hàng</span>';
            }
        }
