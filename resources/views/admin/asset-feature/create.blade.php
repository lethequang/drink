                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <label class="radio-inline">
                                            <input type="radio" name="status" id="status1" value="1" <?=!isset($object['status'])
                                                || @$object['status']=='1' ?'checked':''?>> Kích hoạt
                                        </label>
                                        <label class="radio-inline">
                                            <input type="radio" name="status" id="status2" value="0" <?=@$object['status']=='0'
                                                ?'checked':''?>> Không kích hoạt
                                        </label>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        {!! Form::select("position", $orderOptions, @$object['position'], ['id' =>
                                        'position','class' => 'form-control select2','data-placeholder' => '--- Chọn
                                        thứ tự ---']) !!}
                                        <label id="position-error" class="error" for="position">{!!
                                ...
                                {{--<div class="form-group">--}}
                                    ...
                                    {{--</label>--}}
                                    {{--<div class="col-sm-3">--}}
                                        {{--{!! Form::select("is_range", $isRange, @$object['is_range'], ['id' =>--}}
