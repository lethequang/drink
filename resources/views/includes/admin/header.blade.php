<header class="main-header">
    ...
    <a href="<?=url('/')?>" class="logo">
        ...
        <span class="logo-mini"><b>BĐS</b></span>
        ...
        <div class="navbar-custom-menu">
                        ...
                        <li>
                            ...
                            <ul class="menu">
                                ...
                                <li>
                                    <a href="#">
                                        <div class="pull-left">
                                            <img src="/html-admin/dist/img/user3-128x128.jpg" class="img-circle" alt="User Image">
                                        </div>
                                        <h4>
                                ...
                                <li>
                                    <a href="#">
                                        <div class="pull-left">
                                            <img src="/html-admin/dist/img/user4-128x128.jpg" class="img-circle" alt="User Image">
                                        </div>
                                        <h4>
                                            Developers
            ...
            @if (config('backpack.base.setup_auth_routes'))
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="/html-admin/dist/img/user2-160x160.jpg" class="user-image" alt="User Image">
                        <span class="hidden-xs"><?=@auth('admin')->user()->fullname?></span>
                    </a>
                    <ul class="dropdown-menu">
                        <!-- User image -->
