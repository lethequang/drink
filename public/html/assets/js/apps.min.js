...
$(window).resize(function() {
    if ($(window).width() < 991) {
        $("#navbar").css("height", $(window).height() - $("#header").outerHeight());
    }
});
jQuery(document).ready(function($) {
    ...
    $("#nb-end-date").val(afterTomorrow), $("#nb-start-date").length && $("#nb-start-date").dateRangePicker({
        ...
        autoplaySpeed: 7e3,
        pauseOnHover: !0
    }), $("#rent-range-feet, #book-range-feet").ionRangeSlider({
        type: "double",
        min: $(this).data("min"),
        max: $(this).data("max"),
        from: $(this).data("from"),
        ...
        postfix: "",
        max_postfix: ""
    }), $("#rent-range-price, #book-range-price").ionRangeSlider({
        type: "double",
        min: $(this).data("min"),
        max: $(this).data("max"),
        from: $(this).data("from"),
        ...
        grid: !1,
        prefix: ""
    }), $("#sale-range-feet").ionRangeSlider({
        type: "double",
        min: 1,
        max: 10000,
        from: $(this).data("from"),
        ...
        grid: !1,
        prefix: ""
    }), $("#sale-range-feet-1").ionRangeSlider({
        type: "double",
        min: 1,
        max: 10000,
        from: $(this).data("from"),
